...
RSpec.describe Latergram::SocialPosts do
    ...
    let(:expected_result) do
      {
        ...
        'links' => {
          'first' => 'https://api.latergr.am/v1/social_posts?page=1&per_page=2',
          'last' => 'https://api.latergr.am/v1/social_posts?page=26&per_page=2',
          'next' => 'https://api.latergr.am/v1/social_posts?page=2&per_page=2'
        },
        'meta' => { 'total' => 51 }
      }
    end
